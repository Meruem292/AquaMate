...
import { Loader2, Mail, User, Phone, Lock, Droplets } from 'lucide-react';
...
export function SignupForm() {
  ...
  return (
    <div className="max-w-md w-full mx-auto p-8 border bg-card rounded-lg shadow-lg">
      <div className="text-center mb-8">
        <Link href="/" className="flex items-center justify-center gap-2 mb-4 text-primary">
          <Droplets className="h-8 w-8" />
          <span className="text-2xl font-bold">AquaMate</span>
        </Link>
